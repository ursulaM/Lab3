    ...
    public partial class EditJob : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sqlquery = ("SELECT " +
                "JobName, Salary, Location, JobID FROM Job WHERE JobID = " + sel);
            ...
            if (sdr.Read())
            {
                ...
                HiddenField1.Value = sdr.GetInt32(3).ToString();
        ...
        protected void updtButton_Click(object sender, EventArgs e)
        {
            ...
            string sqlquery = ("UPDATE [Job] SET [JobName]=@Name, [Salary]=@S, [Location]=@L WHERE JobID = @JID");
            SqlCommand command = new SqlCommand(sqlquery, cn);
            command.Parameters.AddWithValue("@Name", TextBox1.Text);
            command.Parameters.AddWithValue("@S", TextBox2.Text);
            command.Parameters.AddWithValue("@L", TextBox3.Text);
            command.Parameters.AddWithValue("@JID", HiddenField1.Value);
            cn.Open();
