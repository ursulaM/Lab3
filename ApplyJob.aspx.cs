...
namespace Lab3
{
    public partial class ApplyJob : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM Job", cn);
                cn.Open();
        ...
        protected void StudentApp_Button(object sender, EventArgs e)
        {
            ...
            string stud = "INSERT INTO [JobApplicant]([StudentID],[JobID],[ApplicationDate], " +
                "[ApplicationDetails],[ApplicationStatus]) VALUES (@SID, @JobID, @Adate, @Adetails, '0')";
            SqlCommand studentapp = new SqlCommand(stud, cj);
            studentapp.Parameters.AddWithValue("@SID", Session["SID"]);
            studentapp.Parameters.AddWithValue("@JobID", DropDownList1.SelectedValue);
