...
FEB 28 2022
This page allows a student to apply for an internship--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Lab3Master.Master" AutoEventWireup="true" CodeBehind="ApplyInternship.aspx.cs" Inherits="Lab3.ApplyInternship" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="DetailsBox" 
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Create Internship Application" OnClick="StudentApp_Button" />
            <br />
