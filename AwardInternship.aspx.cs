...
namespace Lab3
{
    public partial class AwardInternship : System.Web.UI.Page
    {
        ...
        protected void Award(object sender, EventArgs e)
        {
            ...
            string stud = "INSERT INTO StudIntern(InternshipID,StudentID)" +
                "SELECT InternshipID,StudentID FROM InternApplicant " +
            ...
            if (ex > 0)
            {
                string del = "DELETE FROM InternApplicant WHERE ApplicationStatus = '1'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["Lab3"].ConnectionString;
            SqlConnection cj = new SqlConnection(conn);
            string delt = "DELETE FROM InternApplicant WHERE ApplicationStatus = '3'";
